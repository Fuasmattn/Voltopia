...
- [ ] **Step 6: Economy breakdown, census, serialization, UI records, mirror test**
...
- [ ] **Step 3: Create `src/sim/transit.ts` (stop building part)**
...
- [ ] **Step 4: Bulldoze and undo in `roads.ts`**
...
- [ ] **Step 5: Upkeep, command, rejection string**
...
- [ ] **Step 3: Implement fleet, ageing, coverage and tours in `transit.ts`**
...
- [ ] **Step 3: Implement the step, stats and depot info in `transit.ts`**
...
- [ ] **Step 4: `isRider`, buses in occupancy and charging demand (`vehicles.ts`)**
...
- [ ] **Step 5: Tick wiring, stats, budget, renderer hand-off**
...
- [ ] **Step 1: Stop shelters in `roadsMesh.ts`**
...
- [ ] **Step 2: Bus mesh in `vehiclesMesh.ts`**
...
- [ ] **Step 3: Transit overlay in `overlays.ts`**
...
- [ ] **Step 2: Overlay button, chip, inspector, budget, help**
