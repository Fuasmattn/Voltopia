...
- [x] **Step 2: Add the balance block and the insulation cost**
...
- [x] **Step 3: Write the failing daylight tests**
...
- [x] **Step 5: Make daylight parametric**
...
- [x] **Step 6: Run the daylight tests**

Run: `pnpm vitest run src/sim/weather.test.ts`
Expected: PASS

- [x] **Step 7: Write the failing season tests**
...
- [x] **Step 9: Implement `src/sim/seasons.ts`**
...
- [x] **Step 10: Run the season tests**
...
- [x] **Step 11: Typecheck, format, commit**
...
- [x] **Step 5: Extend `SimState` and `createSimState`**
...
- [x] **Step 6: Serialize and deserialize**
...
- [x] **Step 3: Extend the stats types**
...
- [x] **Step 4: Compute the season in `stepTick` and report it**
...
- [x] **Step 3: Implement the seasonal weather**
...
- [x] **Step 5: Run the whole suite, format, commit**
...
- [x] **Step 1: Extend `RenderEnvironment`**
...
- [x] **Step 2: Seasonal sun in `setStats`**
...
- [x] **Step 3: Seasonal ground in `terrain.ts` and palette**
...
- [x] **Step 4: Snowfall in `weatherFx.ts`**
...
- [x] **Step 5: Typecheck, build, smoke**
...
- [x] **Step 1: Add the strings (English)**
...
- [x] **Step 2: Add the strings (German)**
...
- [x] **Step 4: Insulation button next to smart charging**
...
- [x] **Step 5: Heating row in the energy panel**
...
- [x] **Step 6: Help section and temperature chart**
...
- [x] **Step 2: Smoke and visual check** — gate passed in the sandbox; smoke and the visual check are PENDING on the Mac (no WebGL / Chromium here)
...
- [x] **Step 3: Update the plan checkboxes and commit if anything changed**
